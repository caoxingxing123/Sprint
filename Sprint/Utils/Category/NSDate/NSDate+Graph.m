...
- (NSDate *)dateWithDaysAhead:(NSInteger)days{
    ...
    NSCalendar *theCalendar = nil;
    if ([NSCalendar respondsToSelector:@selector(calendarWithIdentifier:)]) {
        theCalendar = [NSCalendar calendarWithIdentifier:NSCalendarIdentifierGregorian];
    } else {
...
- (NSInteger)dayNumber{
    ...
    NSDateComponents *components = [theCalendar components:NSDayCalendarUnit fromDate:self];
...
- (NSString *)weekShortStringDescription{
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
...
- (NSDate *)midnightTime{
    ...
    NSCalendar *gregorian = theCalendar;
