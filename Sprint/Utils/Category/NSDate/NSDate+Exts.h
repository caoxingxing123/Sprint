...
#define CURRENT_CALENDAR  (([NSCalendar respondsToSelector:@selector(calendarWithIdentifier:)])?[NSCalendar calendarWithIdentifier:NSCalendarIdentifierGregorian]:[NSCalendar currentCalendar])
