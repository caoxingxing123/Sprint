...
- (NSDate *)dateBySetSecond:(NSInteger)second
{
    ...
    NSString *yearStr = [NSString stringWithFormat:@"%2ld", (long)second];
...
- (NSDate *)dateBySetMinute:(NSInteger)minute
{
    ...
    NSString *yearStr = [NSString stringWithFormat:@"%2ld", (long)minute];
    dateStr = [dateStr stringByReplacingCharactersInRange:range withString:yearStr];
    NSDate *retDate = [NSDate dateWithString:dateStr];
    return retDate;
}
...
- (NSDate *)dateBySetHour:(NSInteger)hour
{
    ...
    NSString *yearStr = [NSString stringWithFormat:@"%2ld", (long)hour];
    dateStr = [dateStr stringByReplacingCharactersInRange:range withString:yearStr];
    NSDate *retDate = [NSDate dateWithString:dateStr];
    return retDate;
}
...
- (NSDate *)dateBySetDay:(NSInteger)day
{
    ...
    NSString *yearStr = [NSString stringWithFormat:@"%2ld", (long)day];
    dateStr = [dateStr stringByReplacingCharactersInRange:range withString:yearStr];
    NSDate *retDate = [NSDate dateWithString:dateStr];
    return retDate;
}
...
- (NSDate *)dateBySetMonth:(NSInteger)month
{
    ...
    NSString *yearStr = [NSString stringWithFormat:@"%2ld", (long)month];
    dateStr = [dateStr stringByReplacingCharactersInRange:range withString:yearStr];
...
- (NSDate *)dateBySetYear:(NSInteger)year
{
    ...
    NSString *yearStr = [NSString stringWithFormat:@"%4ld", (long)year];
    dateStr = [dateStr stringByReplacingCharactersInRange:range withString:yearStr];
    return [NSDate dateWithString:dateStr];
}
...
#pragma mark - ** 判断昨天、今天、明天 **
- (int)compareDate {
    NSTimeInterval secondsPerDay = 24 * 60 * 60;
//    NSDate *today = [[SynchronizedManager sharedInstance] getServerTime];
    
    NSDate *today = [NSDate date];
    today = [Common reSetCurrentDate:today];    
    ...
    NSDate *tmpDate = [Common reSetCurrentDate:self];
    NSString *dateString = [[tmpDate description] substringToIndex:10];
